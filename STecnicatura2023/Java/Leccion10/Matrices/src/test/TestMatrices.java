...
public class TestMatrices {
    public static void main(String[] args) {
        ...
        edades[1][0] = 8;
        edades[1][1] = 4;
        edades[2][0] = 2; //Terminamos la letra
        edades[2][1] = 9;
        ...
        personas[0][0] = new Persona(("Belén"));
        personas[0][1] = new Persona(("Rocío"));
        personas[0][2] = new Persona(("camila"));
        personas[1][0] = new Persona(("Oscar"));
        personas[1][1] = new Persona(("Blanca"));
